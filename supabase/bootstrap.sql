...
insert into public.operational_settings (tenant_id, order_cutoff_time, expedition_lead_days) values ((select id from public.tenants where legacy_id = 'tenant-seed'), '18:00', 2);
